...
//	private  int numModelParameters;
	...
	public void setAlignment(Alignment alignment) {
		if (this.alignment != null && !(this.alignment.toString().equals(alignment.toString())))
...
//		+ ", weight=" + weight + "]";
	...
	public int getNumBranches() {
		return 2*alignment.getSequenceCount() - 3;
	}
	...
	public void printReport (PrintWriter out, boolean verbose) {
		...
		if (isComputed()) {
			...
			if(verbose) {
				...
				out.println("The alignment:");
				out.println("--------------");
				AlignmentUtils.report(getAlignment(), out);
				out.println("");
			}
		}
	}
